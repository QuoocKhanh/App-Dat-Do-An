...
Button btn;
    ...
    private void ShowAlertDialog() {
        ...
        EditText edtAddress = new EditText(CartListActivity.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Request req = new Request(id, Profille.currentUser.getPhone(),Profille.currentUser.getName(),edtAddress.getText().toString(),TotalTxt.getText().toString(),Order);
